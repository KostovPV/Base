import { Field, Text, RichText, Link, Placeholder, withDatasourceCheck } from '@sitecore-jss/sitecore-jss-nextjs';
...
const CoursesComponent = ({ fields, rendering }: CoursesComponentProps): JSX.Element => {
  const hasCourses = rendering?.placeholders?.['course-list']?.length > 0;
